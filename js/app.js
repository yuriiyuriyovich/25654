  ...
  const m = {
    ...
    offset: function () {
      if (this.length > 0) {
        ...
        return { top: i.top + d - r, left: i.left + c - a };
      }
      return null;
    },
    css: function (e, t) {
  ...
  function C(e) {
    ...
    const c = s > r ? "next" : "prev",
      ...
      u = () => {
        ...
        const e = Math.max(Math.min((o - a) / d, 1), 0),
  ...
  const D = {
    loopCreate: function () {
      ...
      for (let e = a.length - 1; e >= 0; e -= 1)
        n.prepend(g(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  function B(e) {
    ...
    if (c > i.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (g >= i.longSwipesRatio
          ? t.slideTo(i.rewind && t.isEnd ? f : u + T)
          : t.slideTo(u)),
      ...
      (l.target === t.navigation.nextEl || l.target === t.navigation.prevEl)
        ? l.target === t.navigation.nextEl
          ? t.slideTo(u + T)
          : t.slideTo(u)
        : ("next" === t.swipeDirection && t.slideTo(null !== f ? f : u + T),
